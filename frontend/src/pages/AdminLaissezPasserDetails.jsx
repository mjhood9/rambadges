...
const AdminLaissezPasserDetails = () => {
    const { id } = useParams();
    ...
    return (
        <>
            <Helmet>
                <title>Admin RAM Badges | Laissez-Passer Détails</title>
            </Helmet>
            <div className="background">
                <div className="overlay">
                    <div
                        className="back-arrow"
                        onClick={() => navigate("/admin/laissez-passer")}
                    >
...
export default AdminLaissezPasserDetails;