...
const DirecteurLaissezPasserDetails = () => {
    const { id } = useParams();
    ...
    return (
        <>
            <Helmet>
                <title>Directeur RAM Badges | Laissez-Passer Détails</title>
            </Helmet>
            <div className="background">
                <div className="overlay">
                    <div
                        className="back-arrow"
                        onClick={() => navigate("/directeur/laissez-passer")}
                    >
...
export default DirecteurLaissezPasserDetails;