...
// ✅ FIX HERE
    ...
    return (
        <>
            <Helmet>
                <title>Admin RAM Badges | Demande Détails</title>
            </Helmet>
                ...
                {s}
                            ...
                            <div className="summary-box">
                                ...
                                <div style={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
                                    ...
                                    <div style={{ flex: 1, minWidth: "200px" }}>
                                        <p style={{ fontWeight: "600", marginBottom: "8px" }}>
                                            Signature du Correspondant de Sûreté
                                        </p>

                                        {demande.signatureCorrespondant ? (
                                            <img
                                                src={demande.signatureCorrespondant}
                                                alt="Signature correspondant"
                                                style={{
                                                    width: "100%",
                                                    maxHeight: "150px",
                                                    border: "1px solid #ddd",
